    ...
    return (
      <div>
        <textarea
          ...
          onBlur={() => console.log('Textarea lost focus')} // For debugging
        ...
        <button
          ...
          className="mt-2 bg-purple-600 text-white py-2 px-4 rounded-xl hover:bg-purple-700 transition-colors"
        >
