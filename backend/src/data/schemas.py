...
class AIResponse(BaseModel):
    ...
    healing_score: Optional[int] = Field(None, ge=0, le=10, description="Healing effectiveness score")
    sentiment: Optional[SentimentType] = Field(None, description="Message sentiment")
    emotional_state: Optional[str] = Field(None, description="Emotional state detected")
    explanation: Optional[str] = Field(None, description="Why this transformation helps")
    subtext: Optional[str] = Field(None, description="Hidden meaning or subtext")
    needs: Optional[List[str]] = Field(None, description="Emotional needs identified")
    warnings: Optional[List[str]] = Field(None, description="Potential concerns")
    model_used: Optional[str] = Field(None, description="AI model that generated response")
    model_id: Optional[str] = Field(None, description="AI model ID")
